...
class Boiler:
    def __init__(self, bearer_token, capacity=100, wattage=2000, set_tmp=60, one_shower_volume=40, shower_temperature=40, min_tmp=37, hass_url = "http://localhost:8123"):
    ...
    def control_power(self):
        ...
        response = get(self.hass_url, headers=headers)
        print(response.text)
